...
public class ChartTemplateViewForTimo extends Main {
    ...
    public ChartTemplateViewForTimo() {
        ...
        span.addClassNames(LumoUtility.FontSize.LARGE, LumoUtility.TextColor.SECONDARY);
        final var h2 = new H2("%s".formatted(day));
        h2.addClassNames(LumoUtility.FontSize.LARGE, LumoUtility.TextAlignment.CENTER);
